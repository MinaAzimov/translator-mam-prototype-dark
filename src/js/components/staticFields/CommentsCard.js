...
class CommentsCard extends Component {
  ...
  onChange = (e) => {
	...
	render() {
		...
		const { closeFilesInformation, fields, target, selected, onSearchOptimizedSelect, onServiceSelect, onInjestSelect, selectedFilter, selectedFilterOptimezed, selectedFilterSevice, itemStatus, localItem, editingLocalItem, onInputChange, inputUserComments } = this.props;
